...
class HealthService:
    ...
    def record_metric(self, user_id: int, metric_type: str, value: float,
                     unit: str, notes: Optional[str] = None) -> Dict:
        """
    ...
    def get_metrics(self, user_id: int, metric_type: Optional[str] = None,
