...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_user_metric_type", "health_metrics", ["user_id", "metric_type"], unique=False
    )
    op.create_index("idx_user_recorded", "health_metrics", ["user_id", "recorded_at"], unique=False)
    op.create_index(
        op.f("ix_health_metrics_metric_type"), "health_metrics", ["metric_type"], unique=False
    )
    op.create_index(
        op.f("ix_health_metrics_recorded_at"), "health_metrics", ["recorded_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_medical_conditions_user_id"), "medical_conditions", ["user_id"], unique=False
    )
    op.create_table(
        "medications",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_treatment_plans_condition"), "treatment_plans", ["condition"], unique=False
    )
    op.create_index(
        op.f("ix_treatment_plans_created_at"), "treatment_plans", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_treatment_plans_user_id"), "treatment_plans", ["user_id"], unique=False
    )
